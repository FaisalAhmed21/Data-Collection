...
.custom-keyboard .key {
  min-width: 0;
  min-height: clamp(32px, 7vw, 80px);
...
@media (max-width: 600px) {
  ...
  .custom-keyboard .keyboard-row {
    gap: clamp(2px, 1vw, 10px) clamp(2px, 1vw, 10px);
  }
  .custom-keyboard .key {
    min-height: clamp(22px, 6vw, 48px);
...
@media (max-width: 400px) {
  ...
  .custom-keyboard .keyboard-row {
    gap: clamp(1px, 0.5vw, 6px) clamp(1px, 0.5vw, 6px);
  }
  .custom-keyboard .key {
    min-height: clamp(14px, 4vw, 32px);
